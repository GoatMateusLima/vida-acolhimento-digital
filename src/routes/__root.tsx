    ...
    <div className="grid min-h-dvh place-items-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a href="/" className="rounded-lg border px-4 py-2 text-sm font-medium hover:bg-muted">Ir para o início</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Conversa anônima e segura com voluntários treinados em escuta emocional. Acolhimento, não diagnóstico." },
      ...
      { property: "og:description", content: "Conversa anônima e segura com voluntários treinados." },
